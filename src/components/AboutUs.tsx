    ...
    <section id="about-us" className="py-20 bg-gradient-to-b from-white via-stone-50 to-emerald-50/10 border-t border-b border-slate-150 scroll-mt-14 sm:scroll-mt-16 relative overflow-hidden bg-grid-glow">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto flex flex-col space-y-8">
          ...
          <div className="pt-10 grid grid-cols-1 md:grid-cols-2 gap-6 border-t border-slate-150 mt-8">
            ...
            <div className="group bg-white rounded-2xl p-6 border border-slate-100 hover:border-amber-700/20 hover:shadow-md transition-all duration-350 flex items-start gap-4">
              ...
              <div>
                <h4 className="text-sm sm:text-base font-extrabold text-slate-900 font-sans uppercase tracking-wider group-hover:text-amber-800 transition-colors font-sans">State Audited</h4>
